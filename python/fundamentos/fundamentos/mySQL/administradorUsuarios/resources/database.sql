...
CREATE TABLE IF NOT EXISTS `sistema_mensajes`.`roles` (
  ...
  `updated_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE, -- UPDATE: actualiza la fecha y hora
  `created_by` INT NULL,
  `deleted` TINYINT(1) NULL DEFAULT 0, --Borrado logico - No se borra fisicamente
  PRIMARY KEY (`id_rol`))
ENGINE = InnoDB;


-- DIEGO MUERE: DEBEMOS SACARLO DEL SISTEMA. BORRADO FISICO
